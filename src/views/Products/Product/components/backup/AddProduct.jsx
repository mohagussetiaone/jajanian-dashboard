                ...
                <div className="flex flex-col mb-2">
                  ...
                  <div className="flex">
                    <input
                      ...
                      id="variantInput"
                      value={currentTag}
                      className="bg-gray-50 w-[80%] border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-primary-600 focus:border-primary-600 block py-0 px-2 dark:bg-boxdark dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                      placeholder="Masukkan variant"
                      onChange={(e) => setCurrentVariants(e.target.value)}
                    />
                    <button
                      className="w-[20%] bg-primary-500 ml-4 rounded-lg border border-blue-500 text-blue-500 px-4 py-2 dark:bg-blue-500 dark:text-gray-100"
                      onClick={addVariant}
                    >
                      Tambah
                    </button>
                        ...
                        {variants.map((variant, index) => (
                          ...
                          >
                            ...
                            <button
                              ...
                              className="absolute -top-2 -right-2 p-1 text-red-500 bg-gray-100 border-red-500 rounded-full hover:text-red-600 hover:bg-gray-50 focus:outline-none focus:ring-2 z-10"
                            >
