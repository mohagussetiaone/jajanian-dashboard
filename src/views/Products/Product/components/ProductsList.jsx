...
import TruncateCharacter from 'components/TruncateCharacter/TruncateCharacter.js';
      ...
      },
      {
        ...
        cell: (info) => (
          <p className="text-sm text-black dark:text-white">
            {TruncateCharacter(info.row.original.description)}
          </p>
        ),
      },
      {
  ...
  return (
    <>
      <div
        ...
        id="table-container"
      >
        <div className="flex flex-col md:flex-row mx-4 justify-between pt-4">
